...
function renderTodoHeaderTitle(projectTitle, projectId) {
  todoHeaderContainer.replaceChildren();
  const createTodoTitle = document.createElement("h2");
  createTodoTitle.className = `projectId ${projectId}`;
  createTodoTitle.textContent = projectTitle;
